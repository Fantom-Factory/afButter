...
[![pod: v1.2.8](http://img.shields.io/badge/pod-v1.2.8-yellow.svg)](http://eggbox.fantomfactory.org/pods/afButter)
...
Or install `Butter` with [fanr](http://fantom.org/doc/docFanr/Tool.html#install):
